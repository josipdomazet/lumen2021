...
```{r}
{
  dat %>% 
    ...
    ggsave(filename = "images/popular_items.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
...
```{r}
{
  ...
  plot.margin=grid::unit(c(2, 0.3, 2, 2), "mm"))
      ...
      ggsave(filename = "images/born_on_date.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
...
{dat %>% 
  ...
  labs(
    ...
    ggsave(filename = "images/gm_between_0_1.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
...
{dat %>% 
  filter(gm == 1) %>%
  filter(between(invoiced_price, 
                 quantile(invoiced_price, 0.1, na.rm = TRUE),
                 quantile(invoiced_price, 0.9, na.rm = TRUE)
  )
  ) %>% 
  ggplot(aes(invoiced_price)) +
  ...
  theme(text = element_text(size=6),
        plot.margin = grid::unit(c(2, 0.3, 2, 2), "mm"))
          ...
          ggsave(filename = "images/rows_with_gm_1.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
...
{dat %>% 
  ...
  ggsave(filename = "images/prices_by_gm_bins_equal_interval_linear.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
...
{dat %>% 
  ...
  ggsave(filename = "images/prices_by_gm_bins_equal_interval_log.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
