...
```{r}
{
  ...
  ggsave(filename = "images/invoice_order_columns_plot.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
...
```{r}
{
  ...
  ggsave(filename = "images/customers_by_region.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
...
```{r}
{
  ...
  ggsave(filename = "images/customers_by_region_star.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
...

{
  ...
  ggsave(filename = "images/customers_by_region_other.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
...
customer_first_invoice_by_year_plot %>% 
  ggsave(filename = "images/customer_first_invoice_by_year.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
