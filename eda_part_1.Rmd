...
invoice_order_columns_plot %>% 
  ggsave(filename = "invoice_order_columns_plot.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
...
customers_by_region_plot %>% 
  ggsave(filename = "customers_by_region.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
...
```{r}
customers_by_region_star_other_plot <-
  dat %>% 
...
customers_by_region_star_other_plot %>% 
  ggsave(filename = "customers_by_region_star.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
...
customers_by_region_other_plot <-
  dat %>% 
...
customers_by_region_other_plot %>% 
  ggsave(filename = "customers_by_region_other.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
...
customers_by_customer_industry_plot %>% 
  ggsave(filename = "customers_by_customer_industry.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
...
customer_first_invoice_by_year_plot %>% 
  ggsave(filename = "customer_first_invoice_by_year.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
...
n_order_lines_by_man_region_loc_plot <-
  ...
  geom_col() +
  scale_y_reordered() +
  facet_wrap(~ manufacturing_region, scales = "free_y") +
  guides(fill = FALSE) +
  labs(
    x = "Number of order lines",
...
n_order_lines_by_man_region_loc_plot %>% 
  ggsave(filename = "n_order_lines_by_man_region_loc.pdf", 
         width = 11,
         height = 11,
         units = "cm",
         dpi = 300,
...
n_items_by_product_group_plot %>% 
    ggsave(filename = "n_items_by_product_group_plot.pdf", 
         width = 11,
         height = 11,
         units = "cm",
         dpi = 300,
