...
dat %>%
  ...
  theme(text = element_text(size = 6),
    ...
    values = c("Europe" = hue_pal()(4)[1],
          ...
          ggsave(filename = "images/gm_by_customer_region_ridge.pdf", 
         width = 5,
         height = 5,
         units = "cm",
         dpi = 300,
...
dat %>%
  ...
  theme(text = element_text(size = 6),
    ...
    values = c("Europe" = hue_pal()(4)[1],
          ...
          ggsave(filename = "images/gm_by_customer_region_ridge_rm_zero_cost.pdf", 
         width = 5,
         height = 5,
         units = "cm",
         dpi = 300,
...
dat %>%
  ...
  theme(text = element_text(size = 6),
        plot.margin = grid::unit(c(2, 0.3, 2, 2), "mm"))
          ...
          ggsave(filename = "images/gm_by_customer_region_ridge_rm_zero_cost_positive_gm.pdf", 
         width = 5,
         height = 5,
         units = "cm",
         dpi = 300,
...
theme(text = element_text(size = 6),
      plot.margin = grid::unit(c(2, 0.3, 2, 2), "mm")) 
            ...
            ggsave(filename = "images/gm_north_america_normal.pdf", 
         width = 5,
         height = 5,
         units = "cm",
         dpi = 300,
...
theme(text = element_text(size = 6),
      plot.margin = grid::unit(c(2, 0.3, 2, 2), "mm")) 
            ...
            ggsave(filename = "images/gm_europe_normal.pdf", 
         width = 5,
         height = 5,
         units = "cm",
         dpi = 300,
...
```{r}
{
  ...
  ggsave(filename = "images/gm_asa_normal_remove_ic_s.pdf", 
         width = 3,
         height = 3,
         units = "cm",
         dpi = 300,
...
```{r}
{
  ...
  ggsave(filename = "images/gm_asia_intercompany_vs_not_intercomapny.pdf", 
         width = 5,
         height = 5,
         units = "cm",
         dpi = 300,
  ...
  theme(text = element_text(size = 6),
    ...
    labs(
      ...
      y = "Count"
          ...
          ggsave(filename = "images/gm_by_customer_industry_hist.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
...
```{r}
{
  ...
  ggsave(filename = "images/gm_by_customer_industry_boxplots.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
...
```{r}
{
  ...
  ggsave(filename = "images/gm_by_customer_industry_boxplots_by_customer_region.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
...
dat %>%
  ...
  theme(text = element_text(size = 6),
        plot.margin = grid::unit(c(2, 0.3, 2, 2), "mm")
          ...
          ggsave(filename = "images/gm_by_product_family_ridge.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
...
dat %>%
  ...
  theme(text = element_text(size = 6),
          ...
          ggsave(filename = "images/profit_for_each_line_log1p.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
...
dat %>% 
  ...
  plot.margin = grid::unit(c(2, 0.3, 2, 2), "mm"))
      ...
      ggsave(filename = "images/gm_by_binned_shipped_qty.pdf", 
      width = 8,
      height = 8,
      units = "cm",
      dpi = 300,
...
# GREAT: CP30G01, 005999
{
  ...
  plot.margin = grid::unit(c(2, 1.0, 2, 2), "mm"))
        ...
        ggsave(filename = "images/same_item_diff_price_qty.pdf", 
      width = 8,
      height = 8,
      units = "cm",
      dpi = 300,
...
```{r}
{
  ...
  plot.margin = grid::unit(c(2, 1.0, 2, 2), "mm"))
        ...
        ggsave(filename = "images/lower_gm_higher_qty.pdf", 
      width = 8,
      height = 8,
      units = "cm",
      dpi = 300,
...
{ 
  ...
  plot.margin = grid::unit(c(2, 1.0, 2, 2), "mm"))
          ...
          ggsave(filename = "images/higher_qty_higher_profit_with_gm.pdf", 
      width = 8,
      height = 8,
      units = "cm",
      dpi = 300,
...
dat %>% 
  ...
  plot.margin = grid::unit(c(2, 0.3, 2, 2), "mm"))
        ...
        ggsave(filename = "images/gm_by_binned_price_box_all.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 250,
...
dat %>% 
  ...
  plot.margin = grid::unit(c(2, 0.3, 2, 2), "mm"))
        ...
        ggsave(filename = "images/gm_by_binned_price_ridge.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
...
dat %>% 
  ...
  plot.margin = grid::unit(c(2, 0.3, 2, 2), "mm"))
        ...
        ggsave(filename = "images/cost_of_part_by_binned_price_box_all.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
...
```{r}
{
  ...
  plot.margin = grid::unit(c(2, 0.3, 2, 2), "mm"))
        ...
        ggsave(filename = "images/gm_by_binned_price_box_positive_unit_cost.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
...
{dat %>% 
  ...
  plot.margin = grid::unit(c(2, 0.3, 2, 2), "mm"))
        ...
        ggsave(filename = "images/scatter_price_quantity.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
...
{dat %>% 
  ...
  plot.margin = grid::unit(c(2, 0.3, 2, 2), "mm"))
        ...
        ggsave(filename = "images/scatter_price_quantity_special_case.pdf", 
         width = 8,
         height = 8,
         units = "cm",
         dpi = 300,
